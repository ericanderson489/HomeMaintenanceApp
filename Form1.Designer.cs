namespace HomeMaintenanceApp
{
    partial class MainForm
    {
		...
		private void InitializeComponent()
		{
			...
			sidePanel.Controls.Add(mainLoginButton);
			...
			settingsButton.Location = new Point(0, 408);
			settingsButton.Name = "settingsButton";
			settingsButton.Size = new Size(130, 38);
			...
			goalsButton.Location = new Point(12, 100);
			...
			historyButton.Location = new Point(12, 188);
			...
			calendarButton.Location = new Point(12, 144);
			...
			tasksButton.Location = new Point(12, 56);
			...
			dashBoardButton.Location = new Point(12, 12);
			...
			// mainLoginButton
			// 
			mainLoginButton.AutoSize = true;
			mainLoginButton.BackColor = SystemColors.ActiveCaptionText;
			mainLoginButton.FlatStyle = FlatStyle.Popup;
			mainLoginButton.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
			mainLoginButton.ForeColor = SystemColors.ButtonHighlight;
			mainLoginButton.Location = new Point(14, 232);
			mainLoginButton.Name = "mainLoginButton";
			mainLoginButton.Size = new Size(97, 38);
			mainLoginButton.TabIndex = 4;
			mainLoginButton.Text = "Login";
			mainLoginButton.TextAlign = ContentAlignment.MiddleLeft;
			mainLoginButton.UseVisualStyleBackColor = false;
